...
public class CompraControlador {
    ...
    public Compra crearCompra(@PathVariable Long idPropietario, @PathVariable Long idComercial, @PathVariable Long idComprador, @PathVariable Long idInmueble, @RequestBody CompraInputDTO compraInputDTO) {
